...
Match statements are pretty much shortcuts for if-statements with lots of else-ifs. Any expression may be used as a condition for a match case. See the following examples on how to use `match` statements.
```rust
match {
